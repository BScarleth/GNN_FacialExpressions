...
class ModelNet(Dataset):
    ...
    def processed_file_names(self):
        return ["data_{}.pt".format(str(i)) for i in range(4899)]
    ...
    def process_set(self, dataset):
        ...
        for target, category in enumerate(categories):
            ...
            for path in paths:
                ...
                torch.save(data, osp.join(self.processed_dir, f'data_{self.indx}.pt'))
                self.indx += 1
        print("{} graphs have been processed!".format(self.indx))
